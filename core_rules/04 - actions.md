...
#### Melee Actions:
Unless stated otherwise, melee actions have a turn requirement of one that can be reduced to zero at the cost of a penalty die added to this skill check and all other skill cdiff hecks made before the beginning of your next turn.
...
* **Off hand attack(1)** - make a basic attack with one penalty die added to the skill check using a ready weapon in the character’s off hand. The first off hand attack taken each turn has a turn requirement is 0 if the character has made or is making an attack with their primary hand. Lose the weapon’s parry bonus until the beginning of your next turn.

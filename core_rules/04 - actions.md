...
* **Off hand attack(1)** - make a basic attack with one penalty die added to the skill check using a ready weapon in the character’s off hand. The first off-handed attack taken each round has a turn requirement is 0 if the character has made or is making an attack with their primary weapon. Lose the weapon’s parry bonus for one round.

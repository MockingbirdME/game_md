...
* **Basic attack(1)** - make an attack with the character’s body or readied melee weapon. A melee attack skill check use reflexes as its primary attribute, melee combat as its primary skill, and gains the character's rank in the weapon's type secondary skill in bonus dice so long as they are proficient with it.

...
* Off hand attack(1) - make a basic attack with one penalty die added to the skill check using the character’s off hand. This attack’s turn requirement is 0. Lose the weapon’s parry bonus for one round.
* Power attack(2) - make a basic attack with one penalty die added to the skill check; the attack deals additional damage equal to one plus the number of ranks the character has in the power attack secondary skill plus one for each additional success rolled.
...
* Loose/shoot/fire(0) - make an attack with a readied, loaded, ranged weapon. this skill check uses perception as its primary attribute with relevant secondary skill determined by the weapon.
* Ready weapon/ammo(0) - ready a ranged weapon or one plus ranks in reload pieces of ammunition.
* Throw(1) - make a ranged attack with a ready weapon or spell. Gain an additional bonus die for every two ranks in a relevant melee combat secondary skill for this weapon.

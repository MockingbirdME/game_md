...
* **Power attack(2)** - make a basic attack with two penalty dice added to the skill check; the character treats his body stat as if it were 1 greater for the purposes of calculating damage on this attack, additionally each additional success spent to increase the attacks damage increases it by an additional one.

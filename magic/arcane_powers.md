...
* Area of Effect - spell/effect, space, all mages
    ...
    * Line (1+) - the spell or effect affects an area in a straight line 1 meter wide starting with its target hex and continuing X meters forward. Additional successes can be spent to increase this line by X meters, make the line one meter wider, or add up to a 90 degree turn at any point along the line.
...
* Detect Talent - close, arcane, all mages
...
* Suppress magic - short, arcane, all mages
    * null magic zone (3+) - target 1m hex becomes a null magic zone for X rounds, spells cast in this zone have the number of successes rolled reduced by one + one for each additional success spent (max X). Cantrips can not be cast in this zone.
